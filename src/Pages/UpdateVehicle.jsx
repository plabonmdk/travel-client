    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 py-12">
      <div className="card bg-white w-full max-w-lg shadow-2xl rounded-2xl p-8">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            <label className="label font-medium">Price Per Day (USD)</label>
            <input
              type="number"
              name="pricePerDay"
          ...
          <div>
            ...
            <select
              ...
              required
              className="select w-full rounded-full focus:border-0 focus:outline-gray-300"
            >
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows="4"
              className="textarea w-full rounded-2xl focus:border-0 focus:outline-gray-300 h-[150px]"
            />
          </div>
